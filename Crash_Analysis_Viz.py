...
NYC Traffic Crash Intensity and Analysis: 2012-2023
...
with open('Crash_Analysis_Map.html', 'w') as f:
    f.write(html_layout)

print("HTML layout saved as 'Crash_Analysis_Map.html' in the directory. Open this file in a browser to view the result.")
